...
<div class="breadcrumb-wrapper bg-cover" style="background-image: url('assets/img/breadcrumb.png');">
    ...
    <div class="container">
        <div class="page-heading">
            <h1 class="wow fadeInUp" data-wow-delay=".3s">Registrated Your Account</h1>
            ...
            <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="contact-content">
                        ...
                        <form id="contact-form" method="POST" class="contact-form-items">
                            <div class="row g-4">
                                ...
                                <div class="col-lg-7 wow fadeInUp" data-wow-delay=".9s">
                                    <button type="submit" name="btn" class="theme-btn">
