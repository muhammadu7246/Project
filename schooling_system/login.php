...
?>
    ...
    <div class="breadcrumb-wrapper bg-cover" style="background-image: url('assets/img/breadcrumb.png');">
        ...
        <div class="container">
            <div class="page-heading">
                <h1 class="wow fadeInUp" data-wow-delay=".3s">Login Your Account</h1>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".5s">
                                        <div class="form-clt">
                                            ...
                                            <input type="text" name="pass" id="email" placeholder="Your Password">
                                        </div>
                                    </div>
                                    
                                    <div class="col-lg-7 wow fadeInUp" data-wow-delay=".9s">
                                        <button type="submit" name="log" class="theme-btn">
    ...
    if(isset($_POST['log']))
    {
        $name = $_POST['name'];
        $pass = $_POST['pass'];
        $insert = " INSERT INTO `reg`(name,pass) VALUES ('".$name."','".$pass."') ";  // Assuming you want to insert new users
        $query = mysqli_query($conn, $insert);
        
        if ($query) {
          $ab = mysqli_affected_rows($conn);  // Use mysqli_affected_rows here
          // Use $ab (number of rows affected) here
        } else {
          echo "Error: Query failed!";  // Handle the error here
        }
