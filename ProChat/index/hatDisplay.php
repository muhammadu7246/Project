                        ...
                        <div class="side-menu">
                            ...
                            <ul class="nav flex-column nav-pills mb-3" role="tablist">
                                ...
                                <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Logout">
                                    <a href="sessionOut.php" class="nav-link"><i class="feather-lock icon"></i></a>
                                </li>
                            </ul>
                                        ...
                                        <div class="side-menu-header">
                                            ...
                                            <div class="contact-invite">
                                                <a href="#" class="theme-btn" data-bs-toggle="modal"
                                                    ...
                                                    <span class="feather-user-plus"></span>Add Friends
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane profile fade" id="pills-sm5" role="tabpanel"
                                    ...
                                    <div class="side-menu-content">
                                        <div class="side-menu-header">
                                            ...
                                            <a href="editprofile.php" class="theme-btn"><span
                                                    class="feather-user-plus"></span>Edit your profile</a>
                                        </div>
