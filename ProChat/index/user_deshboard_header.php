            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <li
                        ...
                        <a class="nav-link dropdown-toggle d-flex align-items-center nav-item nav-link active" href="#"
                        ...
                        <ul class="dropdown-menu mt-2 dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="sessionOut.php">Sign Out&nbsp;&nbsp;<i
                                    class="fa fa-sign-out-alt" aria-hidden="true"></i></a>
                        </ul>
                    </li>
                    </ul>
                </div>
                ...
                <div class="container px-lg-5">
                    <div class="row g-5">
                        <div class="col-lg-8 text-center text-lg-start">
                            <h1 class="text-white mb-4 animated slideInDown">The Revolutionary App That Helps To
                                communicate together</h1>
                            ...
                            <a href=""
                                ...
                                More</a>
                            <a href="index1.php"
                                class="btn btn-secondary-gradient py-sm-3 px-4 px-sm-5 rounded-pill animated slideInRight">Login</a>
                        </div>
