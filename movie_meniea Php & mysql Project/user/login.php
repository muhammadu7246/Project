...
if (isset($_POST['login'])) {
    ...
    // Build query
    $query = "SELECT * FROM tbl_login WHERE username='$email' AND password='$password'";
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        $_SESSION['username'] = $row['username']; // Set session for the logged-in user
...
<?php
    if (isset($_SESSION['status'])) {
        ...
        unset($_SESSION['status']); // Unset the status after showing it
    }
    ?>
    <!-- ==========Preloader========== -->
    <div class="preloader">   
                ...
                <div class="account-area">
                    ...
                    <form class="account-form" method="post">
                        <div class="form-group">
                            ...
                            <input type="email" placeholder="Enter Your Email" id="email2" name="email" required>
                        </div>
                        <div class="form-group">
