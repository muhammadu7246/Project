                ...
                <div class="row align-items-center mb--20">
                    <div class="col-lg-6 mb-20">
                        <div class="search-ticket-header">
                            <h6 class="category">welcome to moviemania </h6>
    ...
    <section class="movie-section padding-top padding-bottom bg-two">
        <div class="container">
            <div class="row flex-wrap-reverse justify-content-center">
                ...
                // Fetch movie data
                $movieQuery = "SELECT * FROM tbl_movie";
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="movie-grid">
                                        <div class="movie-thumb c-thumb">
                                            <?php
                                            echo '<a href="movie-details.php?id=' . $movie['movie_id'] . '">';
                                            ?>
                                            <img src="<?php echo $movie['image'];?>" alt="<?php echo $movie['image'];?>">
                                            </a>
                                        </div>
                                        <div class="movie-content bg-one">
                                            ...
                                            <ul class="movie-rating-percent">
                                                <li>
                                                    <a href="movie-details.php?id=<?= $movie['movie_id']; ?>" class="custom-button">Book your
                                                        ticket</a>
                                                </li>
                                            </ul>
                                        </div>
