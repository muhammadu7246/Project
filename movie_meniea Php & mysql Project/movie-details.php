                ...
                <div class="container">
                    <div class="details-banner-wrapper">
                        <div class="details-banner-thumb">
                            <img src="user/<?php echo $movie['image']; ?>" alt="movie">
                            <a href="<?php echo $movie['video_url']; ?>" class="video-popup">
    ...
    <section class="book-section bg-one">
        <div class="container">
            <div class="book-wrapper offset-lg-3">
                ...
                <a href="user/register.php" class="custom-button">book tickets</a>
            </div>
        </div>
    </section>
    <!-- ==========Book-Section========== -->
