		...
		<div class="content-top">
				<div class="section group">
					<div class="about span_1_of_2 ">	
						<h1 style="color:white; font-size:15px;" class="text-center mt-6"><?php echo $movie['movie_name']; ?></h1>	
							<div class="about-top">	
								<div class="grid images_3_of_2">
									<img src="<?php echo $movie['image']; ?>" alt=""width="100px" height="100px">
								</div>
							...
							<table class="table table-hover table-bordered text-center">
								...
								<thead>
										<tr>
											<th class="text-center" style="font-size:15;"><b>Theatre</b></th>
							...
							<?php
								...
								?>
								<h3 style="color:white; font-size:20px;" class="text-center">Currently there are no any shows available!</h3>
