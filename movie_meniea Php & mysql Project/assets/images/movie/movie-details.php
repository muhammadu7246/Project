...
<footer class="footer-section">
            ...
            <div class="container">
                <div class="newslater-container bg_img" data-background="assets/images/newslater/newslater-bg01.jpg">
                    <div class="newslater-wrapper">
                        <h5 class="cate">subscribe to moviemania </h5>
        ...
        <div class="container">
            <div class="footer-top">
                <div class="logo">
                    <a href="index-1.html">
                        <img src="assets/images/footer/moviemania-high-resolution-logo-white-transparent.png" alt="footer"width="200" height="80">
                    </a>
                </div>
            ...
            <div class="footer-bottom">
                <div class="footer-bottom-area">
                    <div class="left">
                        <p>Copyright © 2024.All Rights Reserved By <a href="index.php">moviemania </a></p>
                    </div>
                    <ul class="links">
                        <li>
                            <a href="#0">About</a>
