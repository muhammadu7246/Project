						...
						<tbody>
							...
							if (mysqli_num_rows($qry7)) {
								while ($c = mysqli_fetch_array($qry7)) {
									...
									<tr>
										<td>
											<div class="main__table-text"><?php echo $c['user_id']; ?></div>
										</td>
										<td>
											<div class="main__table-text"><a href="#"><?php echo $c['name']; ?></a></div>
										</td>
										<td>
										...
										<td>
											<div class="main__table-text"><?php echo $c['phone']; ?></div>
										</td>
                                        <td>
											<div class="main__table-text"><?php echo $c['age']; ?></div>
										</td>
										<td>
											<div class="main__table-btns">

												<a href="#" onclick="dels(<?php echo $c['user_id']; ?>)" class="main__table-btn main__table-btn--view">
													<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
														<path
															d="M21.92,11.6C19.9,6.91,16.1,4,12,4S4.1,6.91,2.08,11.6a1,1,0,0,0,0,.8C4.1,17.09,7.9,20,12,20s7.9-2.91,9.92-7.6A1,1,0,0,0,21.92,11.6ZM12,18c-3.17,0-6.17-2.29-7.9-6C5.83,8.29,8.83,6,12,6s6.17,2.29,7.9,6C18.17,15.71,15.17,18,12,18ZM12,8a4,4,0,1,0,4,4A4,4,0,0,0,12,8Zm0,6a2,2,0,1,1,2-2A2,2,0,0,1,12,14Z" />
													</svg>
												</a>
												<a href="#" onclick="dele(<?php echo $c['user_id']; ?>)"  class="main__table-btn main__table-btn--edit">
													<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
														<path
															d="M22,7.24a1,1,0,0,0-.29-.71L17.47,2.29A1,1,0,0,0,16.76,2a1,1,0,0,0-.71.29L13.22,5.12h0L2.29,16.05a1,1,0,0,0-.29.71V21a1,1,0,0,0,1,1H7.24A1,1,0,0,0,8,21.71L18.87,10.78h0L21.71,8a1.19,1.19,0,0,0,.22-.33,1,1,0,0,0,0-.24.7.7,0,0,0,0-.14ZM6.83,20H4V17.17l9.93-9.93,2.83,2.83ZM18.17,8.66,15.34,5.83l1.42-1.41,2.82,2.82Z" />
													</svg>
												</a>
												<a href="#modal-delete" onclick="deld(<?php echo $c['user_id']; ?>)"
												...
												<script>
													...
													// Show image
													function dels(x) {
														if (confirm("Are you want to Show this User Detail") == true) {
															window.location = "show_user.php?mid=" + x;
														}
													}
													// edit image
													function dele(n) {
														if (confirm("Are you want to Edit this User Detail") == true) {
															window.location = "edit_user.php?mid=" + n;
														}
													}
												</script>
											</div>
